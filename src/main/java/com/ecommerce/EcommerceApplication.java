...
public class EcommerceApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		User user1 = new User();
		user1.setFirstName("Chathuranga");
		user1.setLastName("Nanayakkara");
		user1.setUsername("chathurangan");
		user1.setPassword(SecurityUtility.passwordEncoder().encode("chathu"));
		user1.setEmail("chathuranga77@gmail.com");
