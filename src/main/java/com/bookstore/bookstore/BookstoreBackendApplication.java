...
public class BookstoreBackendApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception{
        User user1 = new User();
        user1.setFirstName("Chamod");
        user1.setLastName("Kanishka");
        user1.setUsername("chamodkanishka");
        user1.setPassword(SecurityUtility.passwordEncoder().encode("chamod"));
        user1.setEmail("chamodkanishka77@gmail.com");
